...
$monthlyReports = $generateReport->AllMonthlyGeneratedReports();
?>
<div class="container-fluid">
    <div class="d-sm-flex justify-content-between align-items-center mb-4">
        <h3 class="text-dark mb-0">Monthly Generated Report(s)</h3>
    </div>
    <div class="container mt-5">


        <table id="monthlyReportsTable" class="table table-bordered">
            ...
            <tbody>
                <?php $count =0; foreach($monthlyReports as $report): $count++ ?>
                <tr>
